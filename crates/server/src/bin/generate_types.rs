...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::task_packet::CreateTaskPacket::decl(),
        db::models::task_packet::CreateTaskPacketResult::decl(),
        db::models::task_packet::TaskPacket::decl(),
        db::models::task_packet::TaskPacketResult::decl(),
        ...
        server::routes::task_packets::TaskPacketAdapterManifest::decl(),
        server::routes::task_packets::CompileAndDispatchTaskPacket::decl(),
        server::routes::task_packets::TaskPacketRunDetails::decl(),
        db::models::task_packet_run::TaskPacketRepositoryMapping::decl(),
        db::models::task_packet_run::TaskPacketProjectSettings::decl(),
        db::models::task_packet_run::UpsertTaskPacketProjectSettings::decl(),
        db::models::task_packet_run::TaskPacketParentRun::decl(),
        db::models::task_packet_run::TaskPacketRun::decl(),
